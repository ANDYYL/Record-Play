...
#define RAW_RECORD_FILENAME "C:/Users/ANDY/Desktop/MulitimediaExperience/Project/luyin/test.raw"			// 录音文件名(it should be in the same address with the project);
#define WAV_RECORD_FILENAME	"C:/Users/ANDY/Desktop/MulitimediaExperience/Project/luyin/test.wav"			// 录音文件转wav格式文件名;
